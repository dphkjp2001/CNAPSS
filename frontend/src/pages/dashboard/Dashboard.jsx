...
function PostRow({
  ...
  return (
    <button
      type="button"
      onClick={onOpenDetail}
      className="w-full text-left bg-white rounded-xl border border-gray-200 hover:border-gray-300 hover:shadow-md transition-all duration-200 p-4 group"
    >
      <div className="flex items-start gap-4">
        {showBadge && (
          <span className="text-xl flex-shrink-0 mt-1">{badge}</span>
        )}
          ...
          {materialLabels.length > 0 && (
            <div className="flex flex-wrap gap-2 mb-3">
              {materialLabels.map((lbl) => (
                <span
                  key={lbl}
                  className="inline-flex items-center rounded-full bg-gray-50 border border-gray-200 px-3 py-1 text-xs text-gray-700"
                >
                  {lbl}
                </span>
              ))}
            ...
            {currentList.loading ? (
              <div className="space-y-4">
                {Array.from({ length: 8 }).map((_, i) => (
                  <div
                    key={i}
                    className="h-32 rounded-xl bg-white border border-gray-200 animate-pulse"
                  />
                ))}
              </div>
            ) : currentList.items.length ? (
            ...
            <div className="rounded-2xl bg-white border border-gray-200 shadow-sm overflow-hidden">
              <form onSubmit={submitPost}>
                ...
                <div className="px-6 pt-6 pb-4 border-b border-gray-100">
                  <h2 className="font-semibold text-gray-900 mb-1">Create Post</h2>
                  <p className="text-sm text-gray-500">
                    Posting as <span className="font-medium text-gray-700">anonymous</span> in{" "}
                ...
                <div className="p-6">
                  {/* === Seeking: type picker cards === */}
                  {active === "academic" && mode === "seeking" && (
                    <>
                      <div className="grid grid-cols-3 gap-3 mb-6">
                        {[
                          { key: "course_materials", label: "Study Material", icon: "📄" },
                          { key: "coffee_chat", label: "Coffee Chat", icon: "☕️" },
                          { key: "study_mate", label: "Study Group", icon: "👥" },
                        ].map((opt) => {
                          const selected = lookingKind === opt.key;
                          return (
                            <button
                            ...
                            >
                              ...
                              {selected && (
                                <div className="absolute top-2 right-2 w-2 h-2 rounded-full bg-[#FF7A70]" />
                              )}
                            </button>
                          );
                        })}
                    ...
                    <>
                      <div className="mb-4">
                        ...
                        <input
                          ...
                          onChange={(e) => setTitle(e.target.value)}
                          placeholder="Any core course recommendation?"
                          className="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#FF7A70]/20 focus:border-[#FF7A70] transition-all"
                        />
                      </div>
                      ...
                      <div className="mb-4">
                        ...
                        <textarea
                          ...
                          onChange={(e) => setContent(e.target.value)}
                          placeholder="I'm Freshman, and looking for a core course which is not that strictly graded and has no exams."
                          className="w-full min-h-[120px] rounded-lg border border-gray-300 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#FF7A70]/20 focus:border-[#FF7A70] transition-all resize-none"
                        />
                      </div>
                    </>
                  )}
                    ...
                    <>
                      ...
                      <div className="mb-4">
                        ...
                        <textarea
                          ...
                          onChange={(e) => setContent(e.target.value)}
                          placeholder="Describe your academic/career question…"
                          className="w-full min-h-[140px] rounded-lg border border-gray-300 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#FF7A70]/20 focus:border-[#FF7A70] transition-all resize-none"
                        />
                      </div>
                    </>
                  )}
                          ...
                          <div className="space-y-2.5">
                            {[
                              ...
                              >
                                <input
                                  type="checkbox"
                                  className="w-4 h-4 rounded border-gray-300 text-[#FF7A70] focus:ring-[#FF7A70] focus:ring-offset-0"
                                  checked={materials.includes(opt.key)}
                                  onChange={() => toggleMaterial(opt.key)}
                                />
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                    ...
                    <button
                      ...
                      className="px-6 py-2.5 rounded-lg font-medium text-white shadow-sm hover:shadow-md active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                    >
                      {posting ? "Posting…" : "Post"}
                    </button>
                  </div>
